...
namespace OrderEntrySystem
{
    public class CustomerViewModel : WorkspaceViewModel, IDataErrorInfo
    {
        ...
        {
            this.Commands.Add(new CommandViewModel("OK", new DelegateCommand(p => this.OkExecute()), true, false, "CustomerGroup"));
            this.Commands.Add(new CommandViewModel("Cancel", new DelegateCommand(p => this.CancelExecute()), false, true, "CustomerGroup"));
        }
