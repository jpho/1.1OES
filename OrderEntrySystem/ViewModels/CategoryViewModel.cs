...
namespace OrderEntrySystem
{
    public class CategoryViewModel : WorkspaceViewModel, IDataErrorInfo
    {
        ...
        {
            this.Commands.Add(new CommandViewModel("OK", new DelegateCommand(p => this.OkExecute()), true, false, null));
            this.Commands.Add(new CommandViewModel("Cancel", new DelegateCommand(p => this.CancelExecute()), false, true, null));
        }
